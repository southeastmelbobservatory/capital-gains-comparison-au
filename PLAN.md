...
- [x] Embed or generate the CPI dataset from verified ABS table 17 data
- [x] Add a CPI update script with source metadata and repeatable output
...
- [x] Add side-by-side comparison against the legacy rules if the reforms had not changed
- [x] Add focused test cases for the main tax-rule branches and CPI lookup behavior
